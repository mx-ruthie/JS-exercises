...
/* I realized that the string value of a number must be the integer represented as a string, and not the name of the number like "four" -- I also for the purposes of exercise 5 tested the string "true" against the boolean and found they differ as I expected them to. 
*/
...
switch(item){
  ...
  case String:
    ...
    break;
  case undefined:
    answer9 = "Please send a number, that was undefined."
    break;
  case null:
    answer9 = "Please send a number, that was null."
    break;
  default: 
...
function exercise10(num10) {
  ...
  // Write your code for the exercise below here:
  // --------------------------------------------
  if (num10 % 15 === 0) {answer10 = "Fizz Buzz";}
  else if (num10 % 3 === 0) {answer10 = "Fizz";}
  else if (num10 % 5 === 0) {answer10 = "Buzz";}
  else {answer10 = num10;}
  // --------------------------------------------
  // And above here
  // --------------------------------------------
...
// I reviewed my notes to write a switch case but had to google for how to work with anything else in that function and came across using default: as the final case in the function. Stack Overflow ended up being my resource for that. (ex 7).
// I definitely feel like a few of my my lines of code were longer or more complicated than necessary, but I'm not sure in which way. Looking forward to learning more around that. 
